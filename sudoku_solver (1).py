...
def main():
    ...
    # A second, harder sample puzzle (0 = empty cell)
    sample_puzzle_2 = [
        [0, 0, 0, 2, 6, 0, 7, 0, 1],
        [6, 8, 0, 0, 7, 0, 0, 9, 0],
        [1, 9, 0, 0, 0, 4, 5, 0, 0],
    ...
    print("=" * 40)
    print("\n1. Solve sample puzzle 1 (easy)")
    print("2. Solve sample puzzle 2 (harder)")
    print("3. Enter your own puzzle")
    choice = input("\nChoose an option (1/2/3): ").strip()

    if choice == "2":
        puzzle = sample_puzzle_2
    elif choice == "3":
        puzzle = get_puzzle_from_user()
    else:
        puzzle = sample_puzzle_1
